...
export interface paths {
    ...
    "/test": {
        ...
        get: operations["test/get/test"];
        put: operations["test/put/test"];
        post?: never;
        delete: operations["test/delete/test"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        PluginUploadFileDocument: {
            ...
            /**
             * @description A datetime field
             * @default 2025-10-26T12:40:37.832Z
             */
            publishedAt: string;
            related: unknown;
        };
...
export interface operations {
    "product/get/products": {
        parameters: {
            query?: {
                fields?: ("sku" | "name" | "price" | "unit" | "description" | "wholesale" | "wholesale_price" | "wholesale_count" | "createdAt" | "updatedAt" | "publishedAt")[];
                filters?: {
                    [key: string]: unknown;
                };
                _q?: string;
                ...
                sort?: ("sku" | "name" | "price" | "unit" | "description" | "wholesale" | "wholesale_price" | "wholesale_count" | "createdAt" | "updatedAt" | "publishedAt") | ("sku" | "name" | "price" | "unit" | "description" | "wholesale" | "wholesale_price" | "wholesale_count" | "createdAt" | "updatedAt" | "publishedAt")[] | {
                    [key: string]: "asc" | "desc";
                } | {
                    [key: string]: "asc" | "desc";
                }[];
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            /**
                             * @description A datetime field
                             * @default 2025-10-26T12:40:37.830Z
                             */
                            publishedAt: string;
            ...
            content: {
                "application/json": {
                    data: {
                        ...
                        /**
                         * @description A datetime field
                         * @default 2025-10-26T12:40:37.839Z
                         */
                        publishedAt: string;
                        /** @description A media field */
                        images?: unknown[];
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            /**
                             * @description A datetime field
                             * @default 2025-10-26T12:40:37.840Z
                             */
                            publishedAt: string;
                            /** @description A media field */
                            images?: components["schemas"]["PluginUploadFileDocument"][];
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            /**
                             * @description A datetime field
                             * @default 2025-10-26T12:40:37.835Z
                             */
                            publishedAt: string;
                            /** @description A media field */
                            images?: components["schemas"]["PluginUploadFileDocument"][];
            ...
            content: {
                "application/json": {
                    data: {
                        ...
                        /**
                         * @description A datetime field
                         * @default 2025-10-26T12:40:37.841Z
                         */
                        publishedAt?: string;
                        /** @description A media field */
                        images?: unknown[];
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            /**
                             * @description A datetime field
                             * @default 2025-10-26T12:40:37.842Z
                             */
                            publishedAt: string;
                            /** @description A media field */
                            images?: components["schemas"]["PluginUploadFileDocument"][];
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            /**
                             * @description A datetime field
                             * @default 2025-10-26T12:40:37.843Z
                             */
                            publishedAt: string;
                            /** @description A media field */
                            images?: components["schemas"]["PluginUploadFileDocument"][];
    ...
    "test/get/test": {
        parameters: {
            query?: {
                fields?: ("text" | "createdAt" | "updatedAt" | "publishedAt")[];
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            /**
                             * @description A datetime field
                             * @default 2025-10-26T12:40:37.845Z
                             */
                            publishedAt: string;
                        };
                    };
            ...
            content: {
                "application/json": {
                    data: {
                        ...
                        /**
                         * @description A datetime field
                         * @default 2025-10-26T12:40:37.846Z
                         */
                        publishedAt?: string;
                    };
                };
